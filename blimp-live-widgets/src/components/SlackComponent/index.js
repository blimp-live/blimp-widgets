...
export default class SlackComponent extends Component {
  ...
  render() {
    ...
    var authorizeURL = "https://slack.com/oauth/authorize?scope=incoming-webhook&client_id=" + clientId + "&redirect_uri=" + redirectURL;
    if (code == null) {
      return (
        <a href={authorizeURL}>
      ...
      slackfunctions.requestAccessToken(clientId, code, redirectURL);
      return (
